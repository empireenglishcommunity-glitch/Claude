...
CATEGORIES_CONFIG = [
    # ── Category 1: WELCOME (visible to everyone, read-only) ──
    {
        ...
        "channels": [
            {"name": "welcome", "type": "text", "topic": "Welcome to Empire English Community 🏛️"},
            {"name": "rules", "type": "text", "topic": "Community rules — read and accept"},
            {"name": "roles-info", "type": "text", "topic": "How levels work and how to advance"},
            {"name": "announcements", "type": "text", "topic": "Official announcements and updates"},
        ],
    },
    # ── Category 2: SYSTEM ──
    {
        ...
        "overwrites": {
            ...
            "🚀 Level 2": _VIEW_SEND,
            "👑 Level 3": _VIEW_SEND,
            "🌟 Ambassador": _VIEW_SEND,
            "bot": _BOT_FULL,
        },
        "channels": [
            {"name": "bot-commands", "type": "text", "topic": "Interact with Empire Bot: !progress !streak !level"},
            {"name": "leaderboard", "type": "text", "topic": "Auto-updated leaderboards",
             "override": {"🌱 Level 0": _VIEW_ONLY, "💪 Level 1": _VIEW_ONLY, "🚀 Level 2": _VIEW_ONLY, "👑 Level 3": _VIEW_ONLY}},
            {"name": "support", "type": "text", "topic": "Need help? Ask here"},
            {"name": "suggestions", "type": "text", "topic": "Ideas to improve the community"},
        ],
    },
    # ── Category 3: LEVEL 0 ZONE ──
    {
        ...
        "overwrites": {
            "@everyone": _DENY_ALL,
            "🌱 Level 0": _VIEW_SEND_VOICE,
            "💪 Level 1": _VIEW_SEND_VOICE,
            "🚀 Level 2": _VIEW_ONLY,
            "👑 Level 3": _VIEW_ONLY,
            "🌟 Ambassador": _VIEW_SEND_VOICE,
            "bot": _BOT_FULL,
        },
        "channels": [
            {"name": "l0-daily-tasks", "type": "text", "topic": "📅 Daily tasks posted here automatically"},
            {"name": "l0-text-practice", "type": "text", "topic": "Written exercises and submissions"},
            {"name": "l0-voice-1", "type": "voice"},
            {"name": "l0-voice-2", "type": "voice"},
            {"name": "l0-questions", "type": "text", "topic": "Ask questions (Arabic clarification OK here)"},
            {"name": "l0-showcase", "type": "text", "topic": "🎙️ Post recordings and celebrate progress!"},
        ],
    },
    # ── Category 4: LEVEL 1 ZONE ──
    {
        ...
        "overwrites": {
            ...
            "🌱 Level 0": _DENY_ALL,
            "💪 Level 1": _VIEW_SEND_VOICE,
            "🚀 Level 2": _VIEW_SEND_VOICE,
            "👑 Level 3": _VIEW_ONLY,
            "🌟 Ambassador": _VIEW_SEND_VOICE,
            "bot": _BOT_FULL,
        },
        "channels": [
            {"name": "l1-daily-tasks", "type": "text", "topic": "📅 Level 1 daily tasks"},
            {"name": "l1-text-practice", "type": "text", "topic": "Paragraph exercises and submissions"},
            {"name": "l1-voice-1", "type": "voice"},
            {"name": "l1-voice-2", "type": "voice"},
            {"name": "l1-questions", "type": "text", "topic": "Questions about Level 1 content"},
            {"name": "l1-showcase", "type": "text", "topic": "🎙️ Share your progress recordings"},
        ],
    },
    # ── Category 5: LEVEL 2 ZONE ──
    {
        ...
        "overwrites": {
            ...
            "💪 Level 1": _DENY_ALL,
            "🚀 Level 2": _VIEW_SEND_VOICE,
            "👑 Level 3": _VIEW_SEND_VOICE,
            "🌟 Ambassador": _VIEW_SEND_VOICE,
            "bot": _BOT_FULL,
        },
        "channels": [
            {"name": "l2-daily-tasks", "type": "text", "topic": "📅 Level 2 daily tasks"},
            {"name": "l2-text-practice", "type": "text", "topic": "Essays, opinions, complex writing"},
            {"name": "l2-voice-1", "type": "voice"},
            {"name": "l2-voice-2", "type": "voice"},
            {"name": "l2-debate", "type": "voice"},
            {"name": "l2-questions", "type": "text", "topic": "Questions about Level 2 content"},
            {"name": "l2-showcase", "type": "text", "topic": "Share essays and presentations"},
        ],
    },
    # ── Category 6: LEVEL 3 ZONE ──
    {
        ...
        "channels": [
            {"name": "l3-daily-tasks", "type": "text", "topic": "📅 Level 3 daily tasks"},
            {"name": "l3-text-practice", "type": "text", "topic": "Advanced writing and style"},
            {"name": "l3-voice-1", "type": "voice"},
            {"name": "l3-voice-2", "type": "voice"},
            {"name": "l3-debate", "type": "voice"},
            {"name": "l3-mentorship", "type": "text", "topic": "Mentor lower levels, share techniques"},
            {"name": "l3-showcase", "type": "text", "topic": "Advanced work showcase"},
        ],
    },
    # ── Category 7: COMMUNITY (all members) ──
    {
        ...
        "channels": [
            {"name": "general-chat", "type": "text", "topic": "Off-topic English conversation"},
            {"name": "introductions", "type": "text", "topic": "Introduce yourself to the community!"},
            {"name": "voice-lounge", "type": "voice"},
            {"name": "events", "type": "text", "topic": "Upcoming voice sessions and challenges"},
            {"name": "daily-word", "type": "text", "topic": "📖 Word of the day — use it in a sentence!"},
        ],
    },
    # ── Category 8: ACCOUNTABILITY ──
    {
        ...
        "channels": [
            {"name": "daily-check-in", "type": "text", "topic": "Morning: plan tasks. Evening: report."},
            {"name": "streak-tracker", "type": "text", "topic": "🔥 Auto-updated streaks",
             "override": {"🌱 Level 0": _VIEW_ONLY, "💪 Level 1": _VIEW_ONLY, "🚀 Level 2": _VIEW_ONLY, "👑 Level 3": _VIEW_ONLY}},
            {"name": "weekly-goals", "type": "text", "topic": "Set and review weekly goals every Monday"},
        ],
    },
    # ── Category 9: RESOURCES ──
    {
        ...
        "channels": [
            {"name": "cheat-sheets", "type": "text", "topic": "AI-generated reference materials"},
            {"name": "video-library", "type": "text", "topic": "Curated clips and movies by level"},
            {"name": "podcast-recs", "type": "text", "topic": "Recommended listening by level"},
            {"name": "book-club", "type": "text", "topic": "Monthly reading + discussion"},
        ],
    },
    # ── Category 10: FEEDBACK ──
    {
        ...
        "channels": [
            {"name": "speaking-feedback", "type": "text", "topic": "Post recordings for AI/peer feedback"},
            {"name": "writing-feedback", "type": "text", "topic": "Submit writing for correction"},
            {"name": "accent-feedback", "type": "text", "topic": "Pronunciation clips for feedback"},
            {"name": "grammar-qa", "type": "text", "topic": "Grammar questions and answers"},
        ],
    },
    # ── Category 11: ADMIN (hidden) ──
    {
        ...
        "overwrites": {
            ...
            "🚀 Level 2": _DENY_ALL,
            "👑 Level 3": _DENY_ALL,
            "🌟 Ambassador": _DENY_ALL,
            "⚔️ Moderator": _VIEW_SEND,
            "🛡️ Admin": _VIEW_SEND,
            "bot": _BOT_FULL,
        },
        "channels": [
            {"name": "admin-chat", "type": "text", "topic": "Private admin discussion"},
            {"name": "mod-actions", "type": "text", "topic": "Log of moderation actions"},
            {"name": "member-notes", "type": "text", "topic": "Notes on specific members"},
            {"name": "bot-logs", "type": "text", "topic": "Bot error logs and execution records"},
        ],
    },
]
...
class ServerSetup(discord.Client):
    ...
    async def _verify(self, guild: discord.Guild):
        ...
        bot_role = guild.self_role
        level_roles = ["🌱 Level 0", "💪 Level 1", "🚀 Level 2", "👑 Level 3"]
        can_assign = all(
